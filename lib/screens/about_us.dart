              ...
              children: [
                ...
                _buildSectionCard(
                  ...
                  content:
                      ...
                      "that works well in low-resource environments and on low-end devices...",
                ),
                SizedBox(height: 20),
                _buildSectionCard(
                  context,
                  ...
                  content:
                      "Elimu focuses on simplicity, accessibility, and collaboration...",
                ),
                SizedBox(height: 20),
                _buildUseCaseSection(Colors.blueAccent),
                SizedBox(height: 40),
                Center(
                  child: Text(
